...
<!-- 여기만 건들여 -->
		<div id="page-wrapper">
		<h1>책 관리</h1> 
								<div id="rDivBook" style="width: 70vw; height: 45vh"></div>
	...
	function doInit() {
		...
		dxGrid = new dhtmlXGridObject('rDivBook');

		dxGrid
				.setHeader('번호,책제목,책타이틀,책내용,수정,삭제');

		dxGrid
				.setColumnIds('gmjbookno,gmjbookname,gmjbooktitle,gmjbookdesc,edit,delete');
		dxGrid.setColTypes('ro,ed,ed,ed,img,img');
		...
		au.send({
			...
			success : function(res) {
				...
				console.log(res);
				console.log(res[0].gmjvboardurl);
				gmjVboardurl='<'+res[0].gmjvboardurl
				dxGrid.parse(res, 'js');
				insertImg();
			}
		})
