	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">건문지</a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="index.html"><i class="fa fa-dashboard fa-fw"></i>대쉬보드</a>
						</li>
						<li><a href="#"><i class="fa fa-edit fa-fw"></i> 지도 관리</a></li>
						<li><a href="#"><i class="fa fa-edit fa-fw"></i> 회원 관리</a></li>
						...
						<li><a href="tables.html"><i class="fa fa-table fa-fw"></i>추천글
								관리</a></li>
						<li><a href="tables.html"><i class="fa fa-table fa-fw"></i>영상게시판
								관리</a></li>
						<li><a href="tables.html"><i class="fa fa-table fa-fw"></i>트위터배너
								관리</a></li>
						<li><a href="tables.html"><i class="fa fa-table fa-fw"></i>책
								관리</a></li>
